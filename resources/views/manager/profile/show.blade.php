...
@section('content')
    ...
    @php
        // الاسم الكامل: نفضّل بروفايل المدير إن وُجد، ثم باقي الأدوار ثم الاسم/البريد
        $fullName = trim(collect([
            trim(optional($user->managerProfile)->first_name.' '.optional($user->managerProfile)->last_name),
        ...
        // رقم هاتف المدير (من أي بروفايل متاح)
        $managerPhone = optional($user->managerProfile)->phone
            ?? optional($user->adminProfile)->phone
            ?? optional($user->teacher)->phone
            ?? null;
    @endphp
    ...
    <div class="container-fluid">
        ...
        <div class="profile-hero mb-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div class="hero-meta d-flex align-items-center">
                    ...
                    @endif
                    @if($managerPhone)
                        <div class="item"><i class="bi bi-telephone"></i><span>{{ $managerPhone }}</span></div>
                    @endif
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card card-clean h-100">
                    ...
                    <div class="card-body text-end">
                        ...
                        @php
                            $bio = optional($user->managerProfile)->bio
                                ?? optional($user->adminProfile)->bio
                                ?? optional($user->teacher)->bio
                                ?? null;
                        @endphp
                        @if($bio)
            ...
            {{-- المعهد المُدار + روابط المدير --}}
            <div class="col-lg-6">
                <div class="card card-clean h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h6 class="section-title"><i class="bi bi-building"></i> المعهد المُدار</h6>
                                ...
                                <div class="flex-grow-1 text-end">
                                    ...
                                    <div class="inst-actions mt-3 d-flex flex-wrap gap-2 justify-content-end">
                                        <a href="{{ route('manager.classes.index') }}" class="btn btn-sm btn-primary">
                                            <i class="bi bi-grid"></i> إدارة الحلقات
                                        </a>
                            ...
                            <div class="inst-pills">
                                @foreach($institutes as $i)
                                    <a class="pill {{ (isset($inst) && $i->id === $inst->id) ? 'active' : '' }}"
                                       href="{{ route('manager.profile.show', ['institute_id'=>$i->id]) }}"
