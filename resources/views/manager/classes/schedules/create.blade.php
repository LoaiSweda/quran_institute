{{-- resources/views/manager/classes/schedules/create.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('manager.classes.edit', $class->id) }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('manager.classes.schedules.store', $class->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="day_of_week" id="day_of_week"
                            ...
                            @foreach([
                                ...
                                <option value="{{ $key }}" @selected(old('day_of_week')==$key)>
                                {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4 text-end">
                        ...
                        <a href="{{ route('manager.classes.edit', $class->id) }}" class="btn btn-outline-secondary">
                            إلغاء
                        </a>
                    </div>
                </form>
