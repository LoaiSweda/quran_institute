{{-- resources/views/manager/guardians/create.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow-sm mb-4 p-4">
            <form action="{{ route('manager.guardians.store') }}" method="POST" class="row g-3">
                @csrf
                            ...
                            @foreach($guardians as $g)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('manager.guardians.edit', $g) }}"
                                           class="btn btn-sm btn-outline-warning" title="تعديل">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form action="{{ route('manager.guardians.destroy', $g) }}"
