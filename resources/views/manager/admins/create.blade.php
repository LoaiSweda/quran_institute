{{-- resources/views/manager/admins/create.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 text-gray-800">إضافة مشرف جديد</h2>
            {{-- زرّ الإلغاء يعود إلى index --}}
        ...
        <div class="card shadow-sm mb-4 p-4">
            <form action="{{ route('manager.admins.store') }}"
                  method="POST"
                ...
                <div class="col-12 text-center mt-4">
                    <button type="submit" class="btn btn-success">
                        <i class="bi bi-save"></i> حفظ المشرف
                    </button>
                </div>
            </form>
        </div>
