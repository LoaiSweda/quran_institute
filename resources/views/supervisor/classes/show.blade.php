...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group" role="group">
            {{-- إدارة طلاب الحلقة (إن كانت مسارات طلاب الحلقة مضافة للمشرف) --}}
            <a href="{{ route('admin.classes.students.index', ['class'=>$class->id, 'institute_id'=>$inst->id]) }}"
            ...
            <a href="{{ route('admin.classes.index', ['institute_id'=>$inst->id]) }}"
                ...
                @forelse($students as $stu)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('admin.students.show', ['student'=>$stu->id, 'institute_id'=>$inst->id]) }}"
