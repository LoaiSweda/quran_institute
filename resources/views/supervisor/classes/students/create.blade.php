                        ...
                        @foreach($students as $i => $stu)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('admin.classes.students.store', ['class'=>$class->id,'institute_id'=>$inst->id]) }}"
                                          method="POST" class="d-inline">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{ $stu->id }}">
                                        <button type="submit" class="btn btn-sm btn-outline-primary" title="أضف الطالب">
