...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.classes.show', ['class'=>$class->id,'institute_id'=>$inst->id]) }}"
        ...
        <div class="card shadow-sm">
            <div class="card-header py-3 d-flex justify-content-between">
                ...
                <a href="{{ route('admin.classes.students.create', ['class'=>$class->id,'institute_id'=>$inst->id]) }}"
            ...
            <div class="card-body p-0">
                <table class="table table-striped mb-0 text-end">
                    ...
                    @forelse($students as $u)
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('admin.classes.students.destroy', ['class'=>$class->id,'user'=>$u->id,'institute_id'=>$inst->id]) }}"
                                      method="POST"
                    ...
                    @empty
                        <tr><td colspan="4" class="text-center text-muted py-3">لا توجد طلاب مضافين.</td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
