...
@section('content')
    <style>
        ...
        .badge-soft { background: rgba(25,135,84,0.12); color: #198754; }
        .institute-pill {
                        ...
                        <div class="d-flex gap-3 align-items-center">
                            ...
                            <div class="text-end">
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="{{ url('/admin/subjects') }}?institute_id={{ $inst->id }}"
                                       class="btn btn-sm btn-outline-secondary">المواد</a>
                                    <a href="{{ url('/admin/teachers') }}?institute_id={{ $inst->id }}"
                                       class="btn btn-sm btn-outline-secondary">المدرّسون</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-footer bg-white">
                            <div class="d-flex flex-wrap gap-2 justify-content-end">
                                @foreach($institutes as $i)
                                    <a href="{{ route('admin.profile.show', ['institute_id'=>$i->id]) }}"
                                       class="institute-pill {{ $i->id === $inst->id ? 'active' : '' }}"
