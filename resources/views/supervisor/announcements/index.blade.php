                ...
                <table class="table table-striped table-hover mb-0">
                    ...
                    @forelse($ads as $ad)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.announcements.show', $ad) }}"
                                   class="btn btn-sm btn-outline-primary" title="عرض">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('admin.announcements.edit', $ad) }}"
                                   class="btn btn-sm btn-outline-warning" title="تعديل">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('admin.announcements.destroy', $ad) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="text-center py-4 text-muted">لا توجد إعلانات منشورة بعد.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
