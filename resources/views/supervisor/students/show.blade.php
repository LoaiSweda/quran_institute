...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.students.index', request()->only('institute_id')) }}" class="btn btn-secondary btn-sm">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-info h-100 shadow-sm">
                    <div class="card-body text-end">
                        ...
                        <p class="display-6">
                            {{ optional($student->classes)->pluck('subject.name')->unique()->count() }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body text-end">
                ...
                <p><strong>تاريخ الميلاد:</strong>
                    {{ $student->birthdate ? \Illuminate\Support\Carbon::parse($student->birthdate)->format('Y-m-d') : '—' }}
                </p>
